...
INTERVENTION_FRONTEND_URL = config('INTERVENTION_FRONTEND_URL', default='cartronic://forgot-password')
INTERVENTION_PASSWORD_RESET_EXPOSE_TOKEN = config('INTERVENTION_PASSWORD_RESET_EXPOSE_TOKEN', default=PASSWORD_RESET_EXPOSE_LINK, cast=bool)
MARKETPLACE_FRONTEND_URL = config('MARKETPLACE_FRONTEND_URL', default='marketplacecartronic://auth/forgot-password')
MARKETPLACE_PASSWORD_RESET_EXPOSE_TOKEN = config('MARKETPLACE_PASSWORD_RESET_EXPOSE_TOKEN', default=PASSWORD_RESET_EXPOSE_LINK, cast=bool)
