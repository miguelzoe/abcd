...
class Reservation(models.Model):
    ...
    pricing_version = models.CharField(max_length=60, blank=True, default='')
...
class ReservationReminder(models.Model):
    """Rappels planifiés pour les rendez-vous confirmés."""
    REMINDER_TYPES = (
    ...
    user = models.ForeignKey('users.User', on_delete=models.CASCADE, related_name='reservation_reminders')
    ...
    class Meta:
        ...
        # IMPORTANT : noms d'index figés pour éviter que Django génère
        # automatiquement une migration de renommage 0007 selon les environnements.
        # Ces noms correspondent à la migration 0005_reservation_reminder.py.
        indexes = [
            models.Index(fields=['user', 'scheduled_for'], name='reservation_user_id_348b61_idx'),
            models.Index(fields=['sent_at', 'scheduled_for'], name='reservation_sent_at_9db08c_idx'),
            models.Index(fields=['reservation', 'reminder_type'], name='reservation_reserva_669a5e_idx'),
        ]
