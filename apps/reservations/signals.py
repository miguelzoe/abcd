        ...
        try:
            ...
            if old_instance.status in ['confirmed', 'in_progress'] and \
               instance.status in ['cancelled', 'completed']:
                ...
                # Seules les urgences rendent le technicien occupé immédiatement.
                # Les rendez-vous planifiés bloquent uniquement le créneau choisi
                # dans son planning; ils ne doivent pas le rendre indisponible tout
                # de suite dans les recherches.
                if instance.is_emergency and instance.technician and instance.technician.status == 'available':
