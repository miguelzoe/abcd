...
class TechnicianAdmin(admin.ModelAdmin):
    ...
    list_display = ['id', 'get_username', 'approval_status', 'status', 'rating', 'total_interventions', 'get_specializations', 'is_available']
    list_filter = ['approval_status', 'status', 'rating', 'user__is_available']
    search_fields = ['user__username', 'user__email', 'user__telephone']
