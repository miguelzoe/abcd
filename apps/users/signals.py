...
def create_user_profile(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        elif instance.user_type in ['vendor', 'auto_shop'] and not hasattr(instance, 'vendor_profile'):
            Vendor.objects.create(
                user=instance,
                partner_type='auto_shop' if instance.user_type == 'auto_shop' else 'parts_seller',
...
def save_user_profile(sender, instance, **kwargs):
    ...
    elif instance.user_type in ['vendor', 'auto_shop'] and hasattr(instance, 'vendor_profile'):
        profile = instance.vendor_profile
        expected_partner_type = 'auto_shop' if instance.user_type == 'auto_shop' else 'parts_seller'
        if profile.partner_type != expected_partner_type:
            profile.partner_type = expected_partner_type
        profile.save()
