...
from apps.marketplace.models import Produit, Piece, Commande, LigneCommande, Avis, MarketplaceArticleType
...
class MarketplaceArticleTypeViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        if getattr(user, 'user_type', None) != 'administrator' and not user.is_staff:
            ...
            raise PermissionDenied("Seul un administrateur peut ajouter un type d’article")
        serializer.save()
    ...
    def perform_update(self, serializer):
        ...
        if getattr(user, 'user_type', None) != 'administrator' and not user.is_staff:
            from rest_framework.exceptions import PermissionDenied
            raise PermissionDenied("Seul un administrateur peut modifier un type d’article")
        serializer.save()
