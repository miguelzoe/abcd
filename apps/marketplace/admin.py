...
try:
    from apps.marketplace.models import MarketplaceArticleType

    @admin.register(MarketplaceArticleType)
    class MarketplaceArticleTypeAdmin(admin.ModelAdmin):
        list_display = ['id', 'code', 'label', 'kind', 'is_active', 'updated_at']
...
try:
    from apps.marketplace.models import MarketplaceVehicle, MarketplaceOrder

    @admin.register(MarketplaceVehicle)
    class MarketplaceVehicleAdmin(admin.ModelAdmin):
        list_display = ['id', 'name', 'brand', 'model', 'year', 'type', 'price', 'location', 'is_active', 'is_featured', 'updated_at']
        list_filter = ['type', 'body_type', 'fuel', 'transmission', 'is_active', 'is_featured', 'location']
        search_fields = ['id', 'name', 'brand', 'model', 'description', 'partner_name']
        ordering = ['-is_featured', '-created_at']
        readonly_fields = ['id', 'created_at', 'updated_at']

    @admin.register(MarketplaceOrder)
    class MarketplaceOrderAdmin(admin.ModelAdmin):
        list_display = ['id', 'client', 'type', 'status', 'payment_status', 'total', 'payment_method', 'created_at']
        list_filter = ['type', 'status', 'payment_status', 'payment_method', 'created_at']
        search_fields = ['id', 'client__user__username', 'client__user__email', 'notes']
        ordering = ['-created_at']
        readonly_fields = ['id', 'created_at', 'updated_at']
except Exception:
    pass
